...
const Form = () => {
  return (
    <div>
      <div className="max-w-5xl max-lg:max-w-3xl mx-auto bg-white p-4">
      <div className="text-center px-6">
        <h2 className="text-slate-900 text-3xl font-bold">Contact Us</h2>
        <p className="text-[15px] text-slate-600 mt-4">Have some big idea or brand to develop and need help?</p>
      </div>

      <div className="grid lg:grid-cols-5 items-center p-2 [box-shadow:0_2px_10px_-3px_rgba(115,120,131,0.6)] rounded-lg mt-12">
        <div className="lg:col-span-2 bg-indigo-800 rounded-lg p-6 h-full max-lg:order-1 relative overflow-hidden max-lg:mt-12">
          <h3 className="text-[24px] text-white font-medium">Contact Information</h3>
          <p className="text-[15px] text-slate-300 leading-relaxed mt-4">Have some big idea or brand to develop and need help?</p>
          <div className="mt-16 relative z-50">
            <ul className="space-y-8">
              <li className="flex items-center text-slate-200 hover:text-white">
                ...
                <a href="javascript:void(0)" className="text-[15px] ml-4">
                  info@example.com
                </a>
              </li>
              <li className="flex items-center text-slate-200 hover:text-white">
            ...
            <ul className="flex flex-wrap gap-y-4 gap-x-5 mt-16">
              <li className="bg-slate-200 hover:bg-white h-9 w-9 rounded-full flex items-center justify-center shrink-0">
                <a href="javascript:void(0)">
                  <svg xmlns="http://www.w3.org/2000/svg" className="w-[18px] h-[18px] fill-slate-900"
                    viewBox="0 0 24 24">
                    <path
        ...
        <div className="px-4 sm:px-8 py-4 lg:col-span-3">
          <form>
            <div className="grid md:grid-cols-2 gap-8">
              <div className="relative flex items-center">
                <input type="text" placeholder="First Name"
                  className="px-2 py-3 bg-white w-full text-sm text-slate-900 border-b border-gray-300 focus:border-slate-900 outline-none" />
                <svg xmlns="http://www.w3.org/2000/svg" fill="#bbb" stroke="#bbb" className="w-4 h-4 absolute right-2"
                  viewBox="0 0 24 24">
              ...
              <div className="relative flex items-center">
                <input type="number" placeholder="Phone No."
                  className="px-2 py-3 bg-white w-full text-sm text-slate-900 border-b border-gray-300 focus:border-slate-900 outline-none" />
                <svg fill="#bbb" className="w-4 h-4 absolute right-2" viewBox="0 0 64 64">
                  <path
              ...
              <div className="relative flex items-center col-span-full">
                <textarea placeholder="Write Message"
                  className="px-2 pt-3 bg-white w-full text-sm text-slate-900 border-b border-gray-300 focus:border-slate-900 outline-none"></textarea>
                <svg xmlns="http://www.w3.org/2000/svg" fill="#bbb" stroke="#bbb" className="w-4 h-4 absolute right-2"
                  viewBox="0 0 682.667 682.667">
                  <defs>
                    <clipPath id="a" clipPathUnits="userSpaceOnUse">
              ...
              <div className="col-span-full">
                <h6 className="text-[15px] text-slate-900 font-medium">Select Subject</h6>
                <div className="flex flex-wrap gap-6 mt-4">
                  <div className="flex items-center">
                    ...
                    <p className="text-sm text-slate-600 ml-3">General Inquiry</p>
                  </div>
                  <div className="flex items-center">
                    ...
                    <p className="text-sm text-slate-600 ml-3">Technical Support</p>
                  </div>
                  <div className="flex items-center">
                    ...
                    <p className="text-sm text-slate-600 ml-3">Website Feedback</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <button type="button"
              className="mt-12 flex items-center justify-center text-sm font-medium lg:ml-auto max-lg:w-full rounded-lg px-4 py-3 tracking-wide cursor-pointer text-white bg-indigo-600 hover:bg-indigo-700">
